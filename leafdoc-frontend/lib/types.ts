// Shared types used by both OpenRouter and Custom-Model code paths.
// IMPORTANT: this file contains TYPES ONLY. Do NOT import the openai SDK here —
// keep all SDK calls inside `"use server"` files (Next.js Server Actions).

export type AnalysisProvider = "openrouter" | "custom";
